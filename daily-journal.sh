...
# Ref: Logic imported from find_latest_post.sh to ensure we link to a valid post
setopt extended_glob

# Search for potential files (recursive) checking date >= 2025-04-08 (from find_latest_post.sh logic)
