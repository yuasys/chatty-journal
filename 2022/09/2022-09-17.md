...
<details>
 ...
 <ul>
  ...
  もっとも、そもそもViteを絡ませるのはReact等のフレームワークプロジェクトが肥大化すると幾何級数的敵にビルドにコストがかかるのを避けるという意味合いらしいので、当面サンプル作りとかが中心の私の場合は、何も急いで実験に加わることも不要だし、公式サイトに貢献できるほどの技術も持ち合わせていないので決して焦る必要はありません。<br> 
